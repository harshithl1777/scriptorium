...
INSERT INTO "new_CodeTemplate" ("authorId", "code", "createdAt", "explanation", "id", "language", "originalId", "title") SELECT "authorId", "code", "createdAt", "explanation", "id", "language", "originalId", "title" FROM "CodeTemplate";
